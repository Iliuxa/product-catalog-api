 ...
 */
final class Version20250314145219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE PRODUCT (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, inn VARCHAR(12) NOT NULL, ean13 VARCHAR(13) NOT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id))');
